  ...
  data() {
    return {
      ...
      items: [
        ...
        { name: 'Datadog', value: 1.0, tags: [TAG_TOOLS] },
        ...
        { name: 'Google Cloud Platform', value: 0.75, tags: [TAG_PLATFORM] },
        { name: 'Java', value: 0.5, tags: [TAG_LANGUAGE] },
        { name: 'Javascript', value: 1.0, tags: [TAG_LANGUAGE, TAG_FRONTEND] },
        { name: 'Kubernetes', value: 0.5, tags: [TAG_PLATFORM] },
        ...
        { name: 'Redis', value: 0.75, tags: [TAG_TECHNOLOGY, TAG_BACKEND] },
        { name: 'RESTful API Design', value: 1.0, tags: [TAG_MISC, TAG_BACKEND] },
        { name: 'Scala', value: 1.0, tags: [TAG_LANGUAGE, TAG_BACKEND] },
        ...
        { name: 'SteamVR', value: 0.25, tags: [TAG_FRAMEWORK] },
        { name: 'Stripe', value: 0.5, tags: [TAG_PLATFORM] },
        { name: 'Supervisor', value: 0.55, tags: [TAG_TECHNOLOGY] },
        { name: 'SVN', value: 0.5, tags: [TAG_TOOLS] },
        { name: 'Test Driven Development', value: 1.0, tags: [TAG_MISC] },
        { name: 'Twilio', value: 0.5, tags: [TAG_PLATFORM] },
        { name: 'Typescript', value: 1.0, tags: [TAG_LANGUAGE, TAG_FRONTEND] },
